...
[BinaryObject]
public readonly partial record struct HciCommandCompleteEvent : IHciEvent<HciCommandCompleteEvent>
{
    /// <inheritdoc />
    ...
    public required ReadOnlyMemory<byte> ReturnParameters { get; init; }
}
