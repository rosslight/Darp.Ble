...
/// Produces a <see cref="HciCommandCompleteEvent{TParameters}"/> with <see cref="HciLeReadNumberOfSupportedAdvertisingSetsResult"/>
/// </summary>
...
{
    /// <inheritdoc />
    public static HciOpCode OpCode => HciOpCode.HCI_LE_Read_Number_Of_Supported_Advertising_Sets;
}