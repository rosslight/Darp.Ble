...
public sealed class MockBlePeripheral : IBlePeripheral
{
    ...
    public Task AddServiceAsync(IGattClientService service) => _services[service.Uuid] = service;
    public IObservable<IGattClientPeer> WhenConnected => _whenConnected;
    public IObservable<IGattClientPeer> WhenDisconnected => _whenDisconnected;
