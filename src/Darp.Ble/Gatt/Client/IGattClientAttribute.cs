...
public interface IGattClientAttribute
{
    ...
    ValueTask<GattProtocolStatus> UpdateValueAsync(
        IGattClientPeer? clientPeer,
        byte[] value,
        CancellationToken cancellationToken
    );
    ...
    public delegate ValueTask<byte[]> OnReadCallback(
        IGattClientPeer? clientPeer,
        CancellationToken cancellationToken
    );
    ...
    public delegate ValueTask<T> OnReadCallback<T>(
        IGattClientPeer? clientPeer,
        CancellationToken cancellationToken
    );
    ...
    public delegate ValueTask<GattProtocolStatus> OnWriteCallback(
        IGattClientPeer? clientPeer,
        byte[] value,
        CancellationToken cancellationToken
    );
    ...
    /// <param name="cancellationToken"> The CancellationToken to cancel the operation </param>
    /// <returns> A valueTask which holds the status of the write operation when completed </returns>
    public delegate ValueTask<GattProtocolStatus> OnWriteCallback<in T>(
        IGattClientPeer? clientPeer,
        T value,
        CancellationToken cancellationToken
    );
