...
public static partial class GattCharacteristicExtensions
{
        ...
        where TProp1 : IBleProperty
    {
        ...
        return new GattTypedClientCharacteristic<T, TProp1>(characteristic, characteristicDeclaration.ReadValue, characteristicDeclaration.WriteValue);
    }
        ...
        where TProp2 : IBleProperty
    {
        ...
        IGattClientCharacteristic characteristic = await service.AddCharacteristicAsync(
                ...
                cancellationToken)
            .ConfigureAwait(false);
        return new GattTypedClientCharacteristic<T, TProp1, TProp2>(characteristic, characteristicDeclaration.ReadValue, characteristicDeclaration.WriteValue);
    }
    ...
    {
        ArgumentNullException.ThrowIfNull(service);
        return service.AddCharacteristicAsync(characteristicDeclaration,
