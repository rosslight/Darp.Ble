...
public static partial class GattCharacteristicExtensions
{
    ...
    /// <param name="value"> The value to update </param>
    /// <returns> A status of the update operation </returns>
    public static GattProtocolStatus UpdateValue<T>(this IGattTypedClientCharacteristic<T, Read> characteristic, T value)
        where T : unmanaged
    {
        ArgumentNullException.ThrowIfNull(characteristic);
    ...
    /// <param name="value"> The value to update </param>
    public static void Notify(this IGattClientCharacteristic<Notify> characteristic, IGattClientPeer? peer, byte[] value)
    {
        ArgumentNullException.ThrowIfNull(characteristic);
    ...
    /// <param name="value"> The value to update </param>
    /// <typeparam name="T"> The type of the value </typeparam>
    public static void Notify<T>(this IGattTypedClientCharacteristic<T, Notify> characteristic, IGattClientPeer peer, T value)
    {
        ArgumentNullException.ThrowIfNull(characteristic);
