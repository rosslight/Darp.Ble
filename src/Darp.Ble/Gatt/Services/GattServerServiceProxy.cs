...
public abstract class GattServerServiceProxy(IGattServerService service) : IGattServerService
{
    ...
    IReadOnlyCollection<IGattServerCharacteristic> IGattServerService.Characteristics =>
    ...
    Task<IGattServerCharacteristic> IGattServerService.DiscoverCharacteristicAsync(
        BleUuid uuid,
