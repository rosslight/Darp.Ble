...
public static class DeviceInformationServiceContract
{
    ...
    )
    {
        ...
        service.TryGetCharacteristic(
            ...
            out TypedGattServerCharacteristic<string, Properties.Read>? manufacturerNameCharacteristic
        );
        service.TryGetCharacteristic(
        ...
        service.TryGetCharacteristic(
            ...
            out TypedGattServerCharacteristic<string, Properties.Read>? hardwareRevisionCharacteristic
        );
        service.TryGetCharacteristic(
            FirmwareRevisionCharacteristic,
            out TypedGattServerCharacteristic<string, Properties.Read>? firmwareRevisionCharacteristic
        );
        service.TryGetCharacteristic(
            SoftwareRevisionCharacteristic,
            out TypedGattServerCharacteristic<string, Properties.Read>? softwareRevisionCharacteristic
        );
        service.TryGetCharacteristic(
