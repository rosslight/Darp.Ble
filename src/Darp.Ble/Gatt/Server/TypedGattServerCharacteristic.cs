...
public class TypedGattServerCharacteristic<T, TProp1>(IGattServerCharacteristic characteristic,
    ...
    where TProp2 : IBleProperty
{
        ...
        TypedGattServerCharacteristic<T, TProp1, TProp2> characteristicDeclaration)
    {
        ...
        return new TypedGattServerCharacteristic<T, TProp2, TProp1>(characteristicDeclaration.Characteristic,
