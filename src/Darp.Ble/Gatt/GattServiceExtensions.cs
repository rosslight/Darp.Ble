...
public static class GattServiceExtensions
{
    ...
    public static async Task<IGattServerService> DiscoverServiceAsync(this IGattServerPeer peer,
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (serviceDeclaration.Type is not GattServiceType.Undefined && service.Type != serviceDeclaration.Type)
            throw new Exception($"Discovered service is of type {service.Type} and does not match declaration {serviceDeclaration.Type}");
        return service;
    }
    ...
    public static async Task<IGattClientService> AddServiceAsync(this IBlePeripheral peripheral,
             ServiceDeclaration serviceDeclaration,
             CancellationToken cancellationToken)
         {
             ArgumentNullException.ThrowIfNull(peripheral);
             ArgumentNullException.ThrowIfNull(serviceDeclaration);
             return await peripheral.AddServiceAsync(serviceDeclaration.Uuid,
